            ...
            <form name="form1" style="width:1100px" onsubmit="return checkForm()" class="d-flex">
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="d-flex ">
                            <figure id="demo-fig">
                                <img src="./MR_uploads_img/<?= $row['MR_pic'] ?>" alt="" id="demo" 
                            ...
                            <input type="hidden" name="imageLocationX" id="imageLocationX" value="">
                            <input type="hidden" name="imageLocationY" id="imageLocationY" value="">
                        </div>
                    </div>
                </div>
            </form>

...
$sql = "INSERT INTO `vb_books`(`isbn`, `name`, `author`, `publishing`, `publish_date`, `version`, `fixed_price`, `stock`, `page`, `pic`, `categories`, `introduction`, `detailData`,`status`,`created_at`) 
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,NOW())";

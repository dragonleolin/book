                ...
                <div style="min-width:700px;margin:0px 30px">
                    ...
                    <div class="form-group d-flex">
                        ...
                        <div style="height: 230px;width: 230px;border: 1px solid #ddd">
                            <img style="object-fit: contain;width: 100%;height: 100%" src="../venderBooks_Management/vb_images/<?= htmlentities($update_row['pic']) ?>" id="demo" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="update form-control" id="introduction" rows="3" style="width:700px;height:290px;resize:none" name="introduction" placeholder="<?= htmlentities($update_row['introduction']) ?>"></textarea>
                    </div>
